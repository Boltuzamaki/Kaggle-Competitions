...
| Geometry-aware output construction | task244: cost 452→72, +1.8370 | Classifies the grid using geometric properties, constructs the result through RoiAlign. Promising but held for isolated Kaggle testing, since RoiAlign is less battle-tested. |
