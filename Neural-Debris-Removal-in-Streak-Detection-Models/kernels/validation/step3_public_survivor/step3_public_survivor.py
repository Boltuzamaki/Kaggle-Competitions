...
# %% [markdown]
# # Step 3B - detection-conditioned public-only survivor gate
#
...
OUT = Path("/kaggle/working/step3_public_survivor")
...
LOCK = {
    ...
    "experiment": "STEP3B_DETECTION_CONDITIONED_PUBLIC_SURVIVOR_GATE",
    "seed": SEED,
