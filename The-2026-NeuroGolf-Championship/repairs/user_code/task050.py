...
def create_model():
    ...
    # Row logic
    nodes.append(helper.make_node('MatMul', ['is_8_i64', 'L_upper'], ['cum_row']))
    nodes.append(helper.make_node('ReduceSum', ['is_8_i64', 'ax_3_1d'], ['row_sum'], keepdims=1))
    nodes.append(helper.make_node('Equal', ['row_sum', 'c2_i64'], ['has_two_row']))
    nodes.append(helper.make_node('Equal', ['cum_row', 'c1_i64'], ['cum_row_1']))
    nodes.append(helper.make_node('And', ['has_two_row', 'cum_row_1'], ['between_row']))
    
    # Col logic
    nodes.append(helper.make_node('Transpose', ['is_8_i64'], ['is_8_T'], perm=[0, 1, 3, 2]))
    nodes.append(helper.make_node('MatMul', ['is_8_T', 'L_upper'], ['cum_col_T']))
    nodes.append(helper.make_node('Transpose', ['cum_col_T'], ['cum_col'], perm=[0, 1, 3, 2]))
    nodes.append(helper.make_node('ReduceSum', ['is_8_i64', 'ax_2_1d'], ['col_sum'], keepdims=1))
    nodes.append(helper.make_node('Equal', ['col_sum', 'c2_i64'], ['has_two_col']))
    nodes.append(helper.make_node('Equal', ['cum_col', 'c1_i64'], ['cum_col_1']))
    nodes.append(helper.make_node('And', ['has_two_col', 'cum_col_1'], ['between_col']))
    
    # Combine
    nodes.append(helper.make_node('Or', ['between_row', 'between_col'], ['is_3_b']))
    
    # Where logic
    nodes.append(helper.make_node('Where', ['is_3_b', 'c3_i64', 'c0_i64'], ['out_3']))
    nodes.append(helper.make_node('Where', ['is_8', 'c8_i64', 'out_3'], ['out_val']))
    ...
    # Squeeze the keepdims=1 from ArgMax
    nodes.append(helper.make_node('Squeeze', ['pred_trans', 'ax_2_1d'], ['output']))
    
    graph = helper.make_graph(nodes, 'task050', [x], [y], inits)
