...
# Input convention: one-hot [1,10,H,W] or padded one-hot where invalid padding has all channels 0.
# Output: same one-hot shape; invalid padding remains all-zero.
...
def build_onnx_model():
    ...
    graph = helper.make_graph(nodes, "task202_scoreable30", [x], [y], init)
