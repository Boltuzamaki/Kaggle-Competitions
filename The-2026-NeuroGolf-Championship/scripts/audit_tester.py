"""
Full 400-task audit comparing our current repairs/ against submissions/tester/extracted/,
...
REP = "repairs"
OTHER = os.path.expandvars(r"C:\Users\chand\.cache\kagglehub\datasets\romantamrazov\neurogolf-submission-5-onnx\versions\1")
OUT_FILE = os.path.join("scratch_onnx", "audit_roman5_results.json")
...
for t in range(1, 401):
    ...
    other_r = audit_one(other_path, t, f"atester_{t}")
    status = other_r[3]
