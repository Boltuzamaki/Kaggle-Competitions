...
def audit_one(path, t):
    ...
    o.profile_file_prefix = f"auditrep_{t}"
    try:
...
def main():
    ...
    with open("submissions/audits/baseline_current_audit.csv", "w", newline="") as f:
        w = csv.writer(f)
